 ...
 * Uses IndicatorEngine.getRangePosition() for data.
 */
public class RangePositionRenderer implements IndicatorChartRenderer {
    ...
    public void render(XYPlot plot, ChartDataProvider provider) {
        ...
        // Get range position from IndicatorEngine
        double[] rangePos = provider.getIndicatorEngine().getRangePosition(period, skip);
