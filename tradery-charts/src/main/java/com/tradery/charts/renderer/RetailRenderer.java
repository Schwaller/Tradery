 ...
 * Uses IndicatorEngine.getRetailDelta() for data.
 */
public class RetailRenderer implements IndicatorChartRenderer {
    ...
    public void render(XYPlot plot, ChartDataProvider provider) {
        ...
        // Get retail delta from IndicatorEngine
        double[] retailDelta = provider.getIndicatorEngine().getRetailDelta(threshold);
