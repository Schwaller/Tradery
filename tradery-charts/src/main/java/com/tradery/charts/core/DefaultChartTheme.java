 ...
 * and picks appropriate indicator colors for the current background brightness.
 */
public class DefaultChartTheme implements ChartTheme {
    ...
    public Color getDimForeground() {
        return isDark() ? dimForeground() : ui("Label.disabledForeground", new Color(80, 80, 85));
    }
