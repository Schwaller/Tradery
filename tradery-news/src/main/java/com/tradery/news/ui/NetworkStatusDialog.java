...
public class NetworkStatusDialog extends JDialog {
    ...
    private void initUI() {
        ...
        JPanel headerInner = new JPanel(new GridBagLayout());
        JPanel placeholder = new JPanel();
        placeholder.putClientProperty(FlatClientProperties.FULL_WINDOW_CONTENT_BUTTONS_PLACEHOLDER, "mac");
        placeholder.setOpaque(false);
        GridBagConstraints hgbc = new GridBagConstraints();
        hgbc.gridx = 0; hgbc.gridy = 0; hgbc.weightx = 1.0; hgbc.anchor = GridBagConstraints.WEST;
        headerInner.add(placeholder, hgbc);
        JLabel title = new JLabel("Network Status");
        title.setFont(new Font("SansSerif", Font.BOLD, 13));
        title.setForeground(UIManager.getColor("Label.disabledForeground"));
        hgbc.gridx = 1; hgbc.weightx = 0; hgbc.anchor = GridBagConstraints.CENTER;
        headerInner.add(title, hgbc);
        hgbc.gridx = 2; hgbc.weightx = 1.0;
        headerInner.add(Box.createHorizontalGlue(), hgbc);
