...
public class IntelDocumentFrame extends JFrame {
    ...
    public IntelDocumentFrame(String docId, String docName, Path docDir,
        ...
        DefaultChallengeSeeder.seedIfEmpty(challengeStore);
    ...
    private JPanel createHeaderBar() {
        ...
        viewToggle.setOnSelectionChanged(i -> {
            if (i < panelInstances.size()) {
                ...
                cardLayout.show(cardPanel, challengesPanel.getCardId());
            }
            updateHeaderButtons();
        });
    ...
    private void buildPanelCards() {
        ...
        challengesPanel = new ChallengesPanel(challengeStore, challengeExecutor, challengeScheduler, this);
        cardPanel.add(challengesPanel.getPanel(), challengesPanel.getCardId());
        challengesPanel.refresh();
    }
