 ...
 * Eliminates duplication of reference line creation across IndicatorChartsManager.
 */
public final class ChartAnnotationHelper {
    ...
    public static void addZeroLine(XYPlot plot, long startTime, long endTime) {
        addHorizontalLine(plot, 0, ChartStyles.DASHED_STROKE, ChartStyles.TEXT_COLOR, startTime, endTime);
    }
    ...
    public static void addRsiLines(XYPlot plot, long startTime, long endTime) {
        ...
        addHorizontalLine(plot, 50, ChartStyles.DASHED_STROKE, ChartStyles.TEXT_COLOR, startTime, endTime);
    ...
    public static void addAdxLines(XYPlot plot, long startTime, long endTime) {
        addHorizontalLine(plot, 20, ChartStyles.DASHED_STROKE, ChartStyles.TEXT_COLOR, startTime, endTime);
