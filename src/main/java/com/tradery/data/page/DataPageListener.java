...
public interface DataPageListener<T> {
     ...
     *
     * @param page     The page whose state changed
     * @param oldState Previous state
     * @param newState New state
     */
    void onStateChanged(DataPage<T> page, PageState oldState, PageState newState);
     ...
     *
     * @param page The page whose data changed
     */
    default void onDataChanged(DataPage<T> page) {
        // Default: do nothing
    }
}
