...
import com.tradery.core.indicators.OrderflowIndicators;
...
public final class OrderflowIndicatorSpecs {
    ...
    public static void registerAll(IndicatorRegistry registry) {
        // All core indicators are now registered individually via other mechanisms
        // DAILY_VOLUME_PROFILE moved to UI layer as it depends on UI classes
    }
