...
public class IndicatorEngine {
    ...
    private com.tradery.core.model.FootprintResult footprintResult;

    /**
     * Get footprint result for all candles.
     * Calculates footprints using aggTrades data.
     */
    private com.tradery.core.model.FootprintResult getFootprint() {
        ...
        footprintResult = (com.tradery.core.model.FootprintResult) cache.get(key);
        return footprintResult;
    }
     ...
     */
    private com.tradery.core.model.Footprint getFootprintAt(int barIndex) {
        com.tradery.core.model.FootprintResult result = getFootprint();
    ...
    public double getImbalanceAtPOC(int barIndex) {
        ...
        for (com.tradery.core.model.FootprintBucket bucket : footprint.buckets()) {
    ...
    public double getExchangeDelta(String exchangeName, int barIndex) {
        ...
        try {
            com.tradery.core.model.Exchange exchange = com.tradery.core.model.Exchange.valueOf(exchangeName);
    ...
    public double getExchangesWithBuyImbalance(int barIndex) {
        ...
        java.util.Set<com.tradery.core.model.Exchange> exchangesWithBuy = new java.util.HashSet<>();
        for (com.tradery.core.model.FootprintBucket bucket : footprint.buckets()) {
    ...
    public double getExchangesWithSellImbalance(int barIndex) {
        ...
        java.util.Set<com.tradery.core.model.Exchange> exchangesWithSell = new java.util.HashSet<>();
        for (com.tradery.core.model.FootprintBucket bucket : footprint.buckets()) {
    ...
    public double getDominantExchange(int barIndex) {
        ...
        com.tradery.core.model.Exchange dominant = footprint.dominantExchange();
